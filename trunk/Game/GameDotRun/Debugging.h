...
#if _DEBUG
#define DEBUGASSERT(check, file, toLog) if(!check) LOG(file, toLog)
#define DEBUGLOG(file, toLog)	LOG(file, toLog)
#else
#define DEBUGASSERT(check, file, toLog) 
#define DEBUGLOG(file, toLog)
#endif
